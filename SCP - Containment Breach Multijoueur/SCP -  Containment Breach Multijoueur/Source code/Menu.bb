	...
	Else
		...
		Select MainMenuTab
			Case 1 ; Nouvelle partie
				...
				Color(255, 255, 255)
				SetFont Font2
				Text(x + width / 2, y + height / 2, "NOUVELLE PARTIE", True, True)
				...
				Text (x + 20 * MenuScale, y + 20 * MenuScale, "Nom:")
				...
				Text(x + 20 * MenuScale, y + 160 * MenuScale, "Activer l'Intro:")
			...
			Case 2 ; Charger partie
				...
				Color(255, 255, 255)
				SetFont Font2
				Text(x + width / 2, y + height / 2, "Charger Partie", True, True)
				SetFont Font1
				...
				If SaveGameAmount = 0 Then
					Text (x + 20 * MenuScale, y + 20 * MenuScale, "Aucune sauvegarde trouvée")
				Else
					x = x + 20 * MenuScale
					y = y + 20 * MenuScale
					For i% = 1 To SaveGameAmount
			...
			Case 3
				...
				Color 255,255,255				
				Text (x + 20 * MenuScale, y + 60 * MenuScale, "Inverser la souris Y-axis:")	
				InvertMouse = DrawTick(x + 200 * MenuScale, y + 58 * MenuScale, InvertMouse)
				
				Color 255,255,255
				Text (x + 20 * MenuScale, y + 100 * MenuScale, "Musique:")		
				MusicVolume = (SlideBar(x + 240*MenuScale, y+100*MenuScale, 150*MenuScale, MusicVolume*100.0)/100.0)
				Color 170,170,170 
				Text (x + 180 * MenuScale, y + 100 * MenuScale, "BAS")							
				Text (x + 426 * MenuScale, y + 100 * MenuScale, "HAUT")	
				
				Color 255,255,255				
				Text (x + 20 * MenuScale, y + 140 * MenuScale, "Activer HUD:")	
				HUDenabled = DrawTick(x + 200 * MenuScale, y + 138 * MenuScale, HUDenabled)		
				
				Color 255,255,255				
				Text (x + 20 * MenuScale, y + 180 * MenuScale, "Activer bump mapping:")	
				BumpEnabled = DrawTick(x + 200 * MenuScale, y + 178 * MenuScale, BumpEnabled)		
				
				Text (x + 20 * MenuScale, y + 220 * MenuScale, "Contrôle:")	
