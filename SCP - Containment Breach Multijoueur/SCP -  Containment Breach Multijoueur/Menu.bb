	...
	Else
		...
		Select MainMenuTab
			Case 1 ; Nouvelle Partie
				...
				Color(255, 255, 255)
				SetFont Font2
				Text(x + width / 2, y + height / 2, "SOLO", True, True)
			...
			Case 2 ;CHARGER UNE PARTIE				
				...
				Color(255, 255, 255)
				SetFont Font2
				Text(x + width / 2, y + height / 2, "CHARGER UNE PARTIE", True, True)
				SetFont Font1
				...
				If SaveGameAmount = 0 Then
					Text (x + 20 * MenuScale, y + 20 * MenuScale, "Aucune partie trouvée")
				Else
					x = x + 20 * MenuScale
					y = y + 20 * MenuScale
					For i% = 1 To SaveGameAmount
			...
			Case 4 ;MP mod
				...
				Color(255, 255, 255)
				SetFont Font2
				Text(x + width / 2, y + height / 2, "Multijoueur", True, True)
				SetFont Font1
