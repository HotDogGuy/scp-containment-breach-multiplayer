...
**** CREDITS ********************************************
	...
	The game is based on the stories of the SCP Foundation (http://www.scp-wiki.net/).
		...
		SCP-008 is based on "SCP-008 - Zombie Plague" by "Lee Byron" (http://scp-wiki.wikidot.com/scp-008)
		SCP-012 is based on "SCP-012 - A Bad Composition", author unknown (http://scp-wiki.wikidot.com/scp-012)		
		SCP-049 is based on "SCP-049 - Plague Doctor", by "Gabriel Jade" (http://scp-wiki.wikidot.com/scp-049)
		...
		SCP-500 is based on "SCP-500 - Panacea" by "far2" (http://scp-wiki.wikidot.com/scp-500)
		SCP-513-1 is based on "SCP-513 - A Cowbell" by "beefwit" (http://scp-wiki.wikidot.com/scp-513)
		SCP-714 is based on "SCP-714 - The Jaded Ring" by "Arcalane" (http://scp-wiki.wikidot.com/scp-714)
		...
		SCP-1025 is based on "SCP-1025 - Encyclopedia of Diseases" by "Lasergoose" (http://scp-wiki.wikidot.com/scp-1025)
	...
	Other
		...
		MonocleBios
			some of the console commands, bugfix for SCP-106's recall protocoll
	...
	...I've probably forgotten to add some names, so if you've contributed something to the game and feel
	your name should be in the credits, send me (Regalis) a PM at the forums.
